...
export function VideoSender(props) {
	...
	function deleteVideo() {
		const updatedMessage = props.messageArray.filter(
			...
			<div className="videoContainer sender">
				<div className="options">
					...
					<div className="optionsSelection sender" style={{ height: 0 }}>
						<div className="option" onClick={reply}>
							Reply
						</div>
						<div onClick={deleteVideo} className="option">
							Delete this video
						</div>
